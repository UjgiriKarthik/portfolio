...
const ProjectsSection = () => {
  const projects = [
    ...
    },
    {
      ...
      description: "A comprehensive restaurant management system enabling customers to book tables online. Features real-time availability, table management, booking confirmations, and admin dashboard for restaurant owners.",
    ...
    },
    {
      ...
      description: "A collection of projects developed during my time at NextWave Academy, showcasing various aspects of full-stack development including responsive web design, API integration, and modern UI/UX principles.",
      image: projectMern,
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-1 gap-12">
          {projects.map((project, index) => (
            ...
            >
              <div className={`project-card grid lg:grid-cols-2 gap-8 items-center ${
